...
if (nexacro._Browser == "Runtime") {
	if (!nexacro._Init_systembase_runtime) {
		...
		nexacro._download = function (url, handle, initname, targetpath, filefilter, filefilterindex) {
			var httpheaderstr = "";
			...
			handle = nexacro.__downloadFileDownloadHandle(url, handle, initname, targetpath, httpheaderstr, filefilter, filefilterindex);
			if (handle == null) {
